...
export type PreferencesTabId = 'apikeys' | 'chat' | 'personas' | 'draw' | 'about' | undefined;
...
export const useLayoutOptimaStore = create<OptimaState & OptimaActions>((_set, _get) => ({
  ...
  closeSearch: () => _set({ showSearch: false }),
  openSearch: () => _set({ ...modalsClosedState, showSearch: true }),
