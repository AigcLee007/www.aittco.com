...
interface UIPreferencesStore {
  ...
  composerQuickButton: 'off' | 'beam';
  setComposerQuickButton: (composerQuickButton: 'off' | 'beam') => void;
...
export const useUIPreferencesStore = create<UIPreferencesStore>()(
  persist(
    (set) => ({
      ...
      setComposerQuickButton: (composerQuickButton: 'off' | 'beam') => set({ composerQuickButton }),
