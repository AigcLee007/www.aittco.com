...
const LLM_TEXT_PLACEHOLDER = '模型 …';
const LLM_TEXT_CONFIGURE = '添加模型 …';
...
const _slotProps = {
  ...
  button: {
    'aria-description': '关闭时可能会过滤选项。打开下拉列以查看所有选项。',
    sx: {
