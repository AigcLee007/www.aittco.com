...
export const themeFontFamilyCss = 'Inter, Helvetica, Arial, sans-serif';
export const themeSerifFontFamilyCss = '"Lora", "Newsreader", Georgia, "Times New Roman", serif';

export const themeCodeFontFamilyCss = 'JetBrains Mono, monospace';
  ...
  colorSchemes: {
    light: {
      palette: {
        ...
        neutral: {
          plainColor: '#1A1A18',
          softBg: '#F0F0EA', // User bubble style
          softHoverBg: '#E6E6DF',
          solidBg: '#1A1A18',
          solidHoverBg: '#2D2D2A',
        },
        text: {
          primary: '#1A1A18',
          secondary: 'rgba(26, 26, 24, 0.7)',
          tertiary: 'rgba(26, 26, 24, 0.5)',
        },
        background: {
          surface: '#F9F9F7', // Claude Beige
          popup: '#FFFFFF',
          level1: '#F9F9F7',
          level2: '#F2F2EE',
          level3: '#EBEBE5',
    ...
    dark: {
      palette: {
        ...
        neutral: {
          softBg: '#2d2d2a', // Claude dark user bubble
          softHoverBg: '#3b3b3b',
        },
        text: {
          primary: '#ececec',
        ...
        background: {
          popup: '#171717',   // Sidebar & Menus
          surface: '#212121', // Main Chat Area
          level1: '#171717',  // Alternative Sidebar
          level2: '#2f2f2f',  // Composer background
          body: '#212121',    // Main Body
        },
      },
    },
  },
