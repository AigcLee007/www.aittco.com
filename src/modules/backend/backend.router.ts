  ...
  listCapabilities: publicProcedure
    .query(async ({ ctx: _unused }): Promise<BackendCapabilities> => {
      return {
        ...
        hasLlmAnthropic: !!env.ANTHROPIC_API_KEY || (!!env.OPENAI_API_KEY && !!env.OPENAI_API_HOST),
        hasLlmAzureOpenAI: !!env.AZURE_OPENAI_API_KEY && !!env.AZURE_OPENAI_API_ENDPOINT,
        hasLlmDeepseek: !!env.DEEPSEEK_API_KEY,
        hasLlmGemini: !!env.GEMINI_API_KEY || (!!env.OPENAI_API_KEY && !!env.OPENAI_API_HOST),
        ...
        hasLlmXAI: !!env.XAI_API_KEY || (!!env.OPENAI_API_KEY && !!env.OPENAI_API_HOST),
        // others
