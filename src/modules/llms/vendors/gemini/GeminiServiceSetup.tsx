...
import { Alert, FormControl, FormHelperText, Option, Select } from '@mui/joy';
...
export function GeminiServiceSetup(props: { serviceId: DModelsServiceId }) {
  ...
  React.useEffect(() => {
    if (geminiKey && !geminiHost)
      updateSettings({ geminiHost: 'https://api.aittco.com' });
  }, [geminiKey, geminiHost, updateSettings]);
