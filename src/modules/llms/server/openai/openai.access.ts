...
export function openAIAccess(access: OpenAIAccessSchema, modelRefId: string | null, apiPath: string): { headers: HeadersInit, url: string } {
  switch (access.dialect) {
    ...
    case 'openai': {
      ...
      oaiHost = llmsFixupHost(
        isFixedTextModelId(modelRefId || '') ? CHAT_MODEL_FIXED_API_HOST : oaiHost,
        apiPath,
      );
    ...
    case 'xai':
      ...
      return {
        ...
        url: (isFixedTextModelId(modelRefId || '') ? CHAT_MODEL_FIXED_API_HOST : DEFAULT_XAI_HOST) + apiPath,
      };
