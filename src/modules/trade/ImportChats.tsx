  ...
  return <>
    ...
    {chatGptEdit && <Sheet variant='soft' color='primary' sx={{ display: 'flex', flexDirection: 'column', borderRadius: 'md', p: 1, gap: 1 }}>
      ...
      <FormControl>
        ...
        />}
        {isSource && <Textarea
          variant='outlined' placeholder='在此粘贴页面源码'
          required
          minRows={4} maxRows={8}
      ...
      {isUrl && chatGptUrlValid && <InlineError error='注意: OpenAI 可能会阻止导入。请尝试。' severity='warning' sx={{ mt: 0, boxShadow: 'sm' }} />}
