...
export type DBlobAsset = DBlobImageAsset | DBlobAudioAsset | DBlobDocumentAsset; // | DBlobVideoAsset | DBlobTextAsset;
...
export type DBlobDocumentAsset = DBlobAssetImplV1<DBlobAssetType.DOCUMENT, DBlobMimeType.DOCUMENT_PDF | DBlobMimeType.DOCUMENT_XLSX | DBlobMimeType.DOCUMENT_DOCX, DocumentAssetMetadata>;
...
export enum DBlobMimeType {
  ...
  // DOCUMENT_PLAIN = 'text/plain', DOCUMENT_HTML = 'text/html',
}
