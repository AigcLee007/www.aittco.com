...
const TITLING_INSTRUCTION = '请在回答的最开始，用 <title>话题标题</title> 的格式为本次对话生成一个简短标题（6字以内）。';
...
export async function runPersonaOnConversationHead(
  ...
  // In-band Titling (Phase 3): No longer needed to call the legacy titling function here,
  // as it is now handled as part of the LLM response itself.
