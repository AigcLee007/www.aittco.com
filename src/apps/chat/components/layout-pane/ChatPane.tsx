...
export function ChatPane(props: {
  ...
  return <>
    ...
    {/* Window group */}
    <OptimaPanelGroupedList title='窗口'>
      ...
      >
        <ListItemButton onClick={handleToggleMultiPane}>
          ...
          {props.isVerticalSplit
            ? (isMultiPane ? '并排显示' : '向下分屏')
            : (isMultiPane ? '并排显示' : '向右分屏')}
        </ListItemButton>
      </ListItem>
    ...
    {/* Chat Actions group */}
    <OptimaPanelGroupedList title='操作'>
      {/* Use 2 columns */}
    ...
    {/* ... how do we name this? ... */}
    <OptimaPanelGroupedList title='角色'>
    ...
    {/* [DEV] Development */}
    {labsDevMode && (
      <OptimaPanelGroupedList title='[开发者]'>
