...
interface CanvasStore {
  ...
  queuePending: number;
  submitGenerateTask: (
      params: { prompt: string, model: string, routingModelId?: string, isVideoModel?: boolean, size?: string, resolution?: string, duration?: number, hd?: boolean, userId?: string, batchSize?: number, uploadedImages?: any[], gptImage2?: any },
